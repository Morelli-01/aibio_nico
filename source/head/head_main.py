...
class NetWrapper(nn.Module):
    def __init__(self, backbone_net: nn.Module, num_classes):
        ...
        # self.cls_fc1 = nn.Linear(self.backbone.embed_dim, self.backbone.embed_dim * 4)
        # self.cls_fc2 = nn.Linear(self.backbone.embed_dim * 4, self.num_classes)
        self.fcn = nn.Linear(self.backbone.embed_dim, self.num_classes)
